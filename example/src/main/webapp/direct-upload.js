Ext.require([ 'Ext.direct.*', 'Ext.form.*', 'Ext.tip.QuickTipManager', 'Ext.form.field.File', 'Ext.form.field.Number',
		'Ext.form.Panel', 'Ext.window.MessageBox' ]);
...
Ext.onReady(function() {
	...
	var tpl = new Ext.XTemplate(
		'File processed on the server.<br />', 'Name: {fileName}<br />', 'Size: {fileSize:fileSize}');
