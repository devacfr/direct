Ext.require([ 'Ext.direct.*', 'Ext.form.*', 'Ext.tip.QuickTipManager',
		'Ext.form.field.File', 'Ext.form.field.Number', 'Ext.form.Panel',
...
Ext
		.onReady(function() {
			 ...
			 * within the enableBuffer delay period (in milliseconds). Slow the
			 * buffering down from the default of 10ms to 100ms
			 */
			...
			var tpl = new Ext.XTemplate('File processed on the server.<br />',
					'Name: {fileName}<br />', 'Size: {fileSize:fileSize}');
