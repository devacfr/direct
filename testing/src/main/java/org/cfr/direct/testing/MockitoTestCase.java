...
public abstract class MockitoTestCase extends Assert {
     ...
     * <b>If you have too many mocks then refactor the code</b> so that it's easy
     * to test/debug without necessity of naming mocks.
     * <p>
     * <b>If you use &#064;Mock annotation then you've got naming mocks for free!</b>
     * &#064;Mock uses field name as mock name. {@link Mock Read more.}
     * <p>
     *
     * See examples in javadoc for {@link Mockito} class
     *
     ...
     * Object oriented programming is more less tackling complexity
     * by dividing the complexity into separate, specific, SRPy objects.
     ...
     * Mockito doesn't mock final methods so the bottom line is: when you
     * spy on real objects + you try to stub a final method = trouble.
     * What will happen is the real method will be called *on mock* but
     * *not on the real instance* you passed to the spy() method.
    ...
    /**
     * Enables stubbing methods. Use it when you want the mock to
     * return particular value when particular method is called.
     * <p>
     ...
     * Read about {@link ArgumentCaptor} or {@link ArgumentMatcher} to find out
     * other ways of matching / asserting arguments passed.
     * <p>
     * Although it is possible to verify a stubbed invocation, usually <b>it's just redundant</b>.
     * Let's say you've stubbed foo.bar().
     * If your code cares what foo.bar() returns then something else breaks(often before even verify() gets executed).
     ...
     * <b>First potential code smell is reset() in the middle of the test method.</b>
     * This probably means you're testing too much.
     ...
     * <p>
     * <b>Don't harm yourself.</b> reset() in the middle of the test method is
     * a code smell (you're probably testing too much).
     * <pre>
     ...
     * Some users who did a lot of classic, expect-run-verify mocking tend
     * to use verifyNoMoreInteractions() very often, even in every test method.
     ...
     * <p>
     * As usual you are going to read <b>the partial mock warning</b>:
     * Object oriented programming is more less tackling complexity by dividing
     * the complexity into separate, specific, SRPy objects.
     * How does partial mock fit into this paradigm? Well, it just doesn't...
     * Partial mock usually means that the complexity has been moved to a different method on the same object.
     * In most cases, this is not the way you want to design your application.
     * <p>
     ...
     * The reason is it guarantees real methods are called against correctly constructed
     * object because you're responsible for constructing the object passed to spy() method.
     * <p>
     * Example:
     * <pre>
    ...
    /**
     * Use doNothing() for setting void methods to do nothing. <b>Beware
     * that void methods on mocks do nothing by default!</b>
     ...
     * Read more: {@link InOrder#verifyNoMoreInteractions()}
     * <p>
     * See examples in javadoc for {@link Mockito} class
     *
     ...
     */
    protected InOrder inOrder(final Object... mocks) {
     ...
     * @return verification mode
     */
    protected VerificationWithTimeout timeout(final int millis) {
        return Mockito.timeout(millis);
    }

    /**
     * First of all, in case of any trouble,
     * I encourage you to read the Mockito
     * FAQ: <a href="http://code.google.com/p/mockito/wiki/FAQ">http://code.google.com/p/mockito/wiki/FAQ</a>
     * <p>
     ...
     * However, this feature is optional <b>because Mockito validates the usage all the time...</b>
     * but there is a gotcha so read on.
     * <p>
     ...
     * One more benefit of having validateMockitoUsage() in &#064;After is that jUnit runner will
     * always fail in the test method with defect
     ...
     * and just click at navigable stack trace element in the exception message to instantly
     * locate the place where you misused mockito.
     * <p>
     ...
     * See examples in javadoc for {@link Mockito} class
     */
    protected void validateMockitoUsage() {
