...
import org.cfr.matcha.handler.processor.StandardRequestData;
...
public class FormPostRequestData extends StandardRequestData {
    ...
    final transient private boolean isUpload;

    /**
     *
     */
    final transient private Form formParameters;

    /**
     *
     */
    final transient private Map<String, FileItem> fileFields;
