...
public class JaxRsDirectJSResource {
     ...
     *
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(JaxRsDirectJSResource.class);
    ...
    public String getDjnJSResource(@PathParam(value = "jsFileName") final String jsFileName) {
        String js;
        if (FILE_DIRECT_API.equals(jsFileName)) {
     ...
     * @return
     */
    protected String generateApiCode(final String jsFileName, final boolean minified) {
     ...
     * @param application
     */
    public void setDirectApplication(@Nonnull final IJaxRsDirectApplication application) {
